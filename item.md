...
{% api-method method="post" host="http://18.218.160.166:5000" path="/item" %}
{% api-method-summary %}
Add Item
...
{% api-method method="patch" host="http://18.218.160.166:5000" path="/item/:item\_id" %}
{% api-method-summary %}
Update Item
{% endapi-method-summary %}
...
{% api-method method="delete" host="http://18.218.160.166:5000" path="/item/:item\_id" %}
{% api-method-summary %}
Delete Item
{% endapi-method-summary %}
